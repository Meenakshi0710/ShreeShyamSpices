    ...
    <Slider {...settings}>
      ...
      <Link className= "text-decoration-none text-reset" to = "/products/jeera">
        <div className='card shadow h-100'>
              <img src="../public/Data/images/Products/cumin.jpg" className="w-100 border-bottom" alt="Cleaning"/>
              ...
              <div className='card shadow h-100'>
              <img src="../public/Data/images/Products/carom.jpg" className="w-100 border-bottom" alt="Cleaning"/>
              <div className='card-body'>
              ...
              <div className='card shadow h-100'>
              <img src="../public/Data/images/Products/fennel.jpg" className="w-100 border-bottom" alt="Cleaning"/>
              <div className='card-body'>
              ...
              <div className='card shadow h-100'>
              <img src="../public/Data/images/Products/mustard.jpg" className="w-100 border-bottom" alt="Cleaning"/>
              <div className='card-body'>
              ...
              <div className='card shadow h-100'>
              <img src="../public/Data/images/Products/coriander.jpg" className="w-100 border-bottom" alt="Cleaning"/>
              <div className='card-body'>
              ...
              <div className='card shadow h-100'>
              <img src="../public/Data/images/Products/fenugreek.jpg" className="w-100 border-bottom" alt="Cleaning"/>
              <div className='card-body'>
